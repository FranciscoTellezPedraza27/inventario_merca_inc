...
import 'package:inventario_merca_inc/modules/dashboard/actions/delete_papeleria.dart';
import 'package:inventario_merca_inc/modules/dashboard/actions/edit_papeleria.dart';
    ...
    child: Container(
      ...
      child: ScrollbarTheme(
        ...
        child: StreamBuilder<QuerySnapshot>(
          stream: FirebaseFirestore.instance.collection('papeleria').orderBy('timestamp').snapshots(),
                  ...
                  children: [
                    ...
                    IconButton(
                      ...
                      onPressed: () {
                        showDialog(
                          context: context,
                          builder: (context) => EditPapeleriaScreen(document: filteredData[index])
                        );
                      },
                    ),
                    IconButton(
                      ...
                      onPressed: () {
                        showDialog(
                          context: context,
                          builder: (context) => DeletePapeleriaScreen(document: filteredData[index])
                        );
                      },
                    ),
                  ],
