...
import 'package:inventario_merca_inc/modules/dashboard/actions/delete_limpieza.dart';
import 'package:inventario_merca_inc/modules/dashboard/actions/edit_limpieza.dart';
    ...
    child: Container(
      ...
      child: ScrollbarTheme(
        ...
        child: StreamBuilder<QuerySnapshot>(
          stream: FirebaseFirestore.instance.collection('limpieza').orderBy('timestamp').snapshots(),
                  ...
                  children: [
                    ...
                    IconButton(
                      ...
                      onPressed: () {
                        showDialog(
                          context: context,
                          builder: (context) => EditLimpiezaScreen(document: filteredData[index])
                        );
                      },
                    ),
                    IconButton(
                      ...
                      onPressed: () {
                        showDialog(
                          context: context,
                          builder: (context) => DeleteLimpiezaScreen(document: filteredData[index])
                        );
                      },
                    ),
                  ],
