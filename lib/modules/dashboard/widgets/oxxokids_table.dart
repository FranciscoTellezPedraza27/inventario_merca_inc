...
import 'package:inventario_merca_inc/modules/dashboard/actions/delete_oxxok.dart';
import 'package:inventario_merca_inc/modules/dashboard/actions/edit_oxxok.dart';
...
class OxxoKidsTableState extends State<OxxoKidsTable> {
  ...
  final double _actionsColumnWidth = 190;
  ...
  return Container(
      ...
      child: ScrollbarTheme(
        ...
        child: StreamBuilder<QuerySnapshot>(
          stream: FirebaseFirestore.instance.collection('oxxokids').orderBy('timestamp').snapshots(),
                  ...
                  children: [
                    ...
                    IconButton(
                      ...
                      onPressed: () {
                        showDialog(
                          context: context,
                          builder: (context) => EditOxxoKScreen(document: filteredData[index])
                        );
                      },
                    ),
                    IconButton(
                      ...
                      onPressed: () {
                        showDialog(
                          context: context,
                          builder: (context) => DeleteOxxoKScreen(document: filteredData[index])
                        );
                      },
                    ),
                  ],
