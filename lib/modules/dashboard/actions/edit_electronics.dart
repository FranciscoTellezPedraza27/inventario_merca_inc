...
class EditElectronicsScreen extends StatefulWidget {
  final QueryDocumentSnapshot document;

  const EditElectronicsScreen({super.key, required this.document});

  @override
  State<EditElectronicsScreen> createState() => _EditElectronicsScreenState();
}

class _EditElectronicsScreenState extends State<EditElectronicsScreen> {
  ...
  late TextEditingController _responsabilidadController;
  ...
  void initState() {
    ...
    _responsabilidadController = TextEditingController(text: data['responsabilidad']?.toString() ?? '');
 ...
 @override
                ...
                child: Column(
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Expanded(child: _buildEditField("Artículo", _articuloController, Remix.shopping_bag_line)),
                    ...
                    Row(
                      children: [
                        Expanded(child: _buildEditField("Modelo", _modeloController, Remix.hashtag)),
                        const SizedBox(width: 20),
                    ...
                    Row(
                      children: [
                        Expanded(child: _buildEditField("N° Producto", _numeroProductoController, Remix.qr_code_line)),
                        const SizedBox(width: 20),
                        Expanded(child: _buildEditField("N° Serie", _numeroSerieController, Remix.barcode_line)),
                      ],
                    ),
                    // Fila 4: Antigüedad y Valor Aprox.
                    Row(
                      children: [
                        Expanded(child: _buildEditField("Antigüedad", _antiguedadController, Remix.hourglass_line)),
                        const SizedBox(width: 20),
                    ...
                    Row(
                      children: [
                        Expanded(child: _buildEditField("Responsable", _responsableController, Remix.id_card_line)),
                        const SizedBox(width: 20),
                        Expanded(child: _buildEditField("Responsabilidad", _responsabilidadController, Remix.shield_user_line)),
                        const SizedBox(width: 20),
                        Expanded(child: _buildEditField("Ubicación", _ubicacionController, Remix.map_line)),
                      ],
                    ),
  ...
  void dispose() {
    ...
    _responsabilidadController.dispose();
