...
class EditHerramientasScreen extends StatefulWidget {
  final QueryDocumentSnapshot document;

  const EditHerramientasScreen({super.key, required this.document});

  @override
  State<EditHerramientasScreen> createState() => _EditHerramientasScreenState();
}

class _EditHerramientasScreenState extends State<EditHerramientasScreen> {
