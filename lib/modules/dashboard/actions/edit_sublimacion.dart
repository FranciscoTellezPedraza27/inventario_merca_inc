...
class EditSublimacionScreen extends StatefulWidget {
  final QueryDocumentSnapshot document;

  const EditSublimacionScreen({super.key, required this.document});

  @override
  State<EditSublimacionScreen> createState() => _EditSublimacionScreenState();
}

class _EditSublimacionScreenState extends State<EditSublimacionScreen> {
