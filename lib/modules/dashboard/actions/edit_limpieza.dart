...
class EditLimpiezaScreen extends StatefulWidget {
  final QueryDocumentSnapshot document;

  const EditLimpiezaScreen({super.key, required this.document});

  @override
  State<EditLimpiezaScreen> createState() => _EditLimpiezaScreenState();
}

class _EditLimpiezaScreenState extends State<EditLimpiezaScreen> {
