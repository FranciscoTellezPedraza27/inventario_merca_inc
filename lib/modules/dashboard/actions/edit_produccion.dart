...
class EditProduccionScreen extends StatefulWidget {
  final QueryDocumentSnapshot document;

  const EditProduccionScreen({super.key, required this.document});

  @override
  State<EditProduccionScreen> createState() => _EditProduccionScreenState();
}

class _EditProduccionScreenState extends State<EditProduccionScreen> {
