...
class EditMobiliarioScreen extends StatefulWidget {
  final QueryDocumentSnapshot document;

  const EditMobiliarioScreen({super.key, required this.document});

  @override
  State<EditMobiliarioScreen> createState() => _EditMobiliarioScreenState();
}

class _EditMobiliarioScreenState extends State<EditMobiliarioScreen> {
