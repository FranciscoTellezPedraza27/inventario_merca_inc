...
class EditOxxoKScreen extends StatefulWidget {
  final QueryDocumentSnapshot document;

  const EditOxxoKScreen({super.key, required this.document});

  @override
  State<EditOxxoKScreen> createState() => _EditOxxoKScreenState();
}

class _EditOxxoKScreenState extends State<EditOxxoKScreen> {
