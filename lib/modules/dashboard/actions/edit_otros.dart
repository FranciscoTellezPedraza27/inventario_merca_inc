...
class EditOtrosScreen extends StatefulWidget {
  final QueryDocumentSnapshot document;

  const EditOtrosScreen({super.key, required this.document});

  @override
  State<EditOtrosScreen> createState() => _EditOtrosScreenState();
}

class _EditOtrosScreenState extends State<EditOtrosScreen> {
