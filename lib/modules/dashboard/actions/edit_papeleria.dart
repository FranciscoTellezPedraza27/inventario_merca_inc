...
class EditPapeleriaScreen extends StatefulWidget {
  final QueryDocumentSnapshot document;

  const EditPapeleriaScreen({super.key, required this.document});

  @override
  State<EditPapeleriaScreen> createState() => _EditPapeleriaScreenState();
}

class _EditPapeleriaScreenState extends State<EditPapeleriaScreen> {
