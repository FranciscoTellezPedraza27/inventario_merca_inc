...
class _HistorialScreenState extends State<HistorialScreen> {
  ...
  void _cargarCategorias() async {
    ...
    collection: "historial",
    headers: ["Fecha", "Hora", "Usuario", "Categoría", "Tipo Mov.", "Campo", "Valor Anterior", "Valor Nuevo"],
    fields: ["timestamp", "usuario", "categoria", "tipo_movimiento", "campo", "valor_anterior", "valor_nuevo"],
  );
  try {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            icon: const Icon(Icons.filter_alt_outlined, color: Color(0xFF971B81)),
            onPressed: () {},
          ),
        ],
      ),
