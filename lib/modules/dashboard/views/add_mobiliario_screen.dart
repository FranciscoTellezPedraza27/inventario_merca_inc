...
class AddMobiliarioScreen extends StatefulWidget {
  const AddMobiliarioScreen({super.key});

  @override
  _AddMobiliarioScreenState createState() => _AddMobiliarioScreenState();
}

class _AddMobiliarioScreenState extends State<AddMobiliarioScreen> {
  ...
  Future<void> _addElectronic() async {
    if (_formKey.currentState!.validate()) {
      try {
        await FirebaseFirestore.instance.collection('mobiliario').doc().set({
