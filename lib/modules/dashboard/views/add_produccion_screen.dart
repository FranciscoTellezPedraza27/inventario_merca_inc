...
class _AddProduccionScreenState extends State<AddProduccionScreen> {
  ...
  Future<String?> _uploadImage(String docId) async {
    ...
    try {
      final ref = FirebaseStorage.instance.ref(
        'produccion/$docId/${DateTime.now().millisecondsSinceEpoch}'
      );
  ...
  Future<void> _addProduccion() async {
    ...
    try {
      final docRef = FirebaseFirestore.instance.collection('produccion').doc();
      final imageUrl = await _uploadImage(docRef.id);

      final nuevoProduccion = {
